...
import { BgOverlay } from '@/types/image';
  ...
  return (
    <>
      <div className="relative">
        <div className="absolute -top-52 left-0 -z-1 w-full px-2 md:px-7 lg:-top-56">
          <div className="bg-accent relative min-h-300 overflow-hidden rounded-4xl lg:min-h-180">
            <Image
              src={BgOverlay}
              alt="Features"
              width={1000}
            ...
            <div className="gap-base-element">
              <div className="container mx-auto grid grid-cols-1 items-center gap-7 lg:grid-cols-[1fr_512px] lg:gap-24">
                ...
                <p className="text-body-style">
                  Có rất nhiều biến đổi của các đoạn văn có sẵn nhưng phần lớn
                  đã bị thay đổi theo một hình thức, bởi sự thêm vào của con
                  người ngẫu nhiên
                </p>
              </div>
